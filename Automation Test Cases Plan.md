...
| Covered    | E2E-27 | Delete Account from UI                | User / Account        | E2E                 | Verify delete account flow from navigation menu; E2E-1 covers API-level delete, this covers UI flow | tests\e2e\account-delete.spec.ts         |
