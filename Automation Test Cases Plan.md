...
| #   | Test Case                                  | Category       | Automation Type | Notes                                                         | File Name | comments    |
| --- | :----------------------------------------- | -------------- | --------------- | ------------------------------------------------------------- | --------- | ----------- |
| 1   | Register User                              | User / Account | E2E             | Full sign up + delete account, can optimize via API for setup |           |             |
| 2   | Login User with correct email and password | User / Account | E2E             | Include delete account after login                            |           |             |
| 14  | Place Order: Register while Checkout       | Orders         | E2E             | Full checkout flow with account creation                      |           | golden Path |
