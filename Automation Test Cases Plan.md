...
| Covered    | E2E-10 | Verify Subscription in Home Page      | Pages / Subscription  | E2E                 | Footer subscription UI check; BF-002                                                                | tests\e2e\subscription-footer.spec.ts |
| Covered    | E2E-11 | Verify Subscription in Cart Page      | Pages / Subscription  | E2E                 | Footer subscription UI check on cart page; BF-002                                                   | tests\e2e\subscription-footer.spec.ts |
...
| Covered (Known defect) | E2E-10-neg | Verify Subscription in Home Page submits real network request         | Pages / Subscription | E2E                 | Known defect `BF-002`: success message shown without actual network request                                         | tests\e2e\subscription-footer.spec.ts |
| Covered (Known defect) | E2E-11-neg | Verify Subscription in Cart Page submits real network request         | Pages / Subscription | E2E                 | Known defect `BF-002`: success message shown without actual network request                                         | tests\e2e\subscription-footer.spec.ts |
